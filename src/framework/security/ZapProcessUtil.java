...
public class ZapProcessUtil {

	Logger logger = Logger.getLogger(ZapProcessUtil.class);
    ...
    public static void main(String[] args) throws Exception {
        startZap();
        ZapProcessUtil util = new ZapProcessUtil();
    ...
    public void test()
    {
    	...
    	//http://localhost:8090/UI/spider/view/results/
    }
